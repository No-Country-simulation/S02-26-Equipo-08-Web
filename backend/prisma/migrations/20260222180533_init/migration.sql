...
CREATE TABLE "usuario_estado" (
    ...
    CONSTRAINT "usuario_estado_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "usuario" (
    ...
    "id_usuario_estado" INTEGER NOT NULL DEFAULT 1,
...
-- CreateTable
CREATE TABLE "paciente_estado" (
    "id" SERIAL NOT NULL,
    "descripcion" VARCHAR(45) NOT NULL,

    CONSTRAINT "paciente_estado_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "paciente" (
    ...
    "id_paciente_estado" INTEGER NOT NULL DEFAULT 1,
